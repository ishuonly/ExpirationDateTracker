...
// ...
// Add a DELETE route to handle the cancel request
app.delete("/cancel/:name", async (req, res) => {
  try {
    const name = req.params.name;

    // Delete the item from the database based on the name
    await Item.deleteMany({ name });
